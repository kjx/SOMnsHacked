...
//woiuld be better being done in newspeak to do things class-side
class Exception { 
  inherit kernel.Exception
  method raise(str) {signal} 
}

//should subclass I guess
